    ...
    <section id="services" className="py-24 bg-background">
      <div className="container mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="font-serif text-4xl md:text-5xl text-foreground mb-6">{t("services.title")}</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service) => (
            ...
            >
              <div className="mb-4">
                <h3 className="font-serif text-2xl text-foreground mb-1">{language === "es" ? service.nameEs : service.nameEn}</h3>
                <span className="text-sm font-medium tracking-wider text-primary uppercase">{language === "es" ? service.nameEn : service.nameEs}</span>
              </div>
              <p className="text-muted-foreground leading-relaxed mb-8 flex-grow">
                {language === "es" ? service.desc : service.descEn}
              </p>
              <button 
